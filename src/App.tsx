...
const logos = ["MOHAMED UMAR", "DATA SCIENTIST", "TREND PREDICTOR", "AI DEVELOPER", "MACHINE LEARNING", "DEEP LEARNING", "AI ENGINEER", "DATA ANALYST"];
...
animate-[shine_4s_linear_infinite]">
    ...
    from-white via-white/60 to-white
    animate-[shine_4s_linear_infinite]">
                  Leveraging Data, Machine Learning and AI to{" "} <br />
                  <em className="not-italic text-white">
                    build predictive and scalable solutions.
                  </em>
                </p>
