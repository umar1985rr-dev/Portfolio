...
export default function FrontendDeveloperSection() {
  ...
  return (
    ...
    animate-[shine_4s_linear_infinite]"
        >
          Developing intelligent apps featuring clean, adaptive, high-performance interfaces.
          Turning raw datasets and AI insights into powerful, real-world digital solutions.
        </motion.p>
        ...
        >
          {["Python", "SQL", "Pandas", "FastAPI"].map((tech) => (
            <div
              key={tech}
              className="
